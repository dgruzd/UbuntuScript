...
screen -dR q3serv ./ioq3ded.x86_64 +set com_hunkmegs 32 +set net_port 27960 +set dedicated 1 +set vm_game 2 +set vm_cgame 2 +set vm_ui 2 +set fs_game osp +set sv_strictAuth 0 +set sv_punkbuster 0 +set sv_lanForceRate 1 +set sv_maxrate 15000 +seta timelimit 15 +seta fraglimit 0 +map q3dm17
